  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 relative overflow-hidden bg-gradient-to-br from-primary/20 via-background to-background">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_70%_30%,hsl(var(--primary))_0%,transparent_60%)] opacity-10" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_30%_70%,hsl(var(--primary))_0%,transparent_50%)] opacity-10" />
